...
class Program
{
    ...
    static int totalConDiagnostico = 0;
    static int totalTiempoEspera = 0;
    static int totalTiempoDiagnostico = 0;
    static int totalPacientesAtendidos = 0;
    ...
    static void AtenderPaciente(Paciente paciente)
    {
        ...
        lock (lockObj)
        {
            ...
            totalTiempoEspera += paciente.LlegadaHospital;
        }
    ...
    static void Main()
    {
        ...
        Console.WriteLine("Pacientes atendidos: " + totalPacientesAtendidos);
        Console.WriteLine("Pacientes con diagnóstico: " + totalConDiagnostico);
        Console.WriteLine("Tiempo promedio de espera: " + (totalTiempoEspera / totalPacientes) + "s");
        Console.WriteLine("Uso promedio de máquinas de diagnóstico: " + ((double)totalTiempoDiagnostico / (totalConDiagnostico * 15) * 100) + "%");
