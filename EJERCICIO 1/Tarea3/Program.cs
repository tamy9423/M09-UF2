...
class Program
{
    ...
    static void Main()
    {
        ...
        for (int i = 1; i <= 4; i++)
        {
            ...
            Paciente paciente = new Paciente(id, llegadaHospital, tiempoConsulta, i);
            pacientes.Add(paciente);
            
            Console.WriteLine($"Paciente {paciente.Id}. Llegado el {paciente.OrdenLlegada}. Estado: Espera. Duración: 0 segundos.");
